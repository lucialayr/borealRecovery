...
plot_accuracy = function(timespan) {
  ...
  if (file.exists(paste0("data/results/predictive_power_", timespan, ".csv")) == F) {
    data = list()
...
plot_feature_importance = function(timespan) {
  ...
  if (file.exists(paste0("data/results/importance_ranking_", timespan, ".csv")) == F) {
...
ggsave("figures/results/results_rf_2075_2100.pdf",  width = 12, scale = 0.95)
