...
load_climate_variables_eoc = function(var = "tas") {
  ...
  for (s in c("picontrol", "ssp126", "ssp585")) {
    ...
    raster = terra::rast(paste0("data/covariates/mri-esm2-0_r1i1p1f1_", s, "_", var, "_daily_inverted_1850_2300_boreal_monthly.nc")) %>%
...
ggsave("figures/results/growing_season_temperature.pdf", height = 5, width = 10, scale = 1)
